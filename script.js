Shery.imageEffect("#back", {style: 5, config: {
    a:{value:2,range:[0,30]},b:{value:-0.76,range:[-1,1]},
    zindex:{value:-9996999,range:[-9999999,9999999]},
    aspect:{value:1.0262295248729936},ignoreShapeAspect:{value:true},
    ...
    durationOut:{value:0.47,range:[0.1,5]},durationIn:{value:1,range:[0.1,5]},
    displaceAmount:{value:0.5},masker:{value:true},
    maskVal:{value:1,range:[1,5]},
    scrollType:{value:0},geoVertex:{range:[1,64],value:1},
    noEffectGooey:{value:false},
    onMouse:{value:1},noise_speed:{value:1,range:[0,10]},
    metaball:{value:0.16,range:[0,2],_gsap:{id:5}},
    discard_threshold:{value:0.68,range:[0,1]},
    antialias_threshold:{value:0,range:[0,0.1]},
    noise_height:{value:0.63,range:[0,2]},noise_scale:{value:13.74,range:[0,100]}
  },
  gooey: true, });
